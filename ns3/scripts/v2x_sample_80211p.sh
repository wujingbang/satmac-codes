...
##802.11p
#run_config 1000 0 0 0 0 0 64 32 128 0 200 0.1  >> $main_log_file 2>&1 &
#run_config 800 0 0 0 0 0 64 32 128 0 200 0.1  >> $main_log_file 2>&1 &
#run_config 600 0 0 0 0 0 64 32 128 0 200 0.1  >> $main_log_file 2>&1 &
#run_config 400 0 0 0 0 0 64 32 128 0 200 0.1  >> $main_log_file 2>&1 &
#run_config 200 0 0 0 0 0 64 32 128 0 200 0.1  >> $main_log_file 2>&1 &

run_config 1000 0 0 0 0 0 64 32 128 0 200 0.05  >> $main_log_file 2>&1 &
#run_config 800 0 0 0 0 0 64 32 128 0 200 0.05  >> $main_log_file 2>&1 &
#run_config 600 0 0 0 0 0 64 32 128 0 200 0.05  >> $main_log_file 2>&1 &
#run_config 400 0 0 0 0 0 64 32 128 0 200 0.05  >> $main_log_file 2>&1 &
#run_config 200 0 0 0 0 0 64 32 128 0 200 0.05  >> $main_log_file 2>&1 &
